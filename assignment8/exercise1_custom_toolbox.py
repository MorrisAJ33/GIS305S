...
#to alex morris modelbuilder .gdb
...
def buffer_layer(input_gdb, input_layer, dist):
    ...
    output_layer = r"C:\Users\morri\Documents\Alex Morris\GIS 305\Projects\GIS305_1\modelbuilder.gdb\\" + input_layer + "_buf"
...
def main():
    ...
    arcpy.env.workspace = r"C:\Users\morri\Documents\Alex Morris\GIS 305\Projects\GIS305_1\modelbuilder.gdb\\"
    arcpy.env.overwriteOutput = True

    # Buffer cities
    input_gdb = r"C:\Users\morri\Documents\Alex Morris\GIS 305\Data\AdminData.gdb\USA\\"
    ...
    # Get the project
    aprx = arcpy.mp.ArcGISProject(r"C:\Users\morri\Documents\Alex Morris\GIS 305\Projects\GIS305_1\GIS305_1.aprx")
    map_doc = aprx.listMaps()[0]
    map_doc.addDataFromPath(rf"C:\Users\morri\Documents\Alex Morris\GIS 305\Projects\GIS305_1\modelbuilder.gdb\{intersect_lyr_name}")
